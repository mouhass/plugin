...
class exportAdminCommand extends Command
{

    protected static  $defaultName="app:exportAdmin";
    private $mailer;
    private $logger;
    private $kernel;
    protected $manager;
    ...
    {   //******
        ...
        try {
           ...
           // $myfile = fopen("webdictionary.txt", "r");
            ...
            $records = $this->adminRepository->findAll();
            ...
            if(count($records)) {
                ...
                foreach($records as $record) {
                    $data = [$record->getName(),$record->getPassword(),$record->getEmail()]; // false for the shallow conversion
                    fputcsv($csvh, $data, $d, $e);
                }
